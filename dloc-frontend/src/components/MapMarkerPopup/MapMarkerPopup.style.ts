...
const MapMarkerPopupStyle = {
  ...
  SharedWithIconContainerProps: {
    sx: { position: "absolute", left: 40, top: 0, opacity: 0.8 } as SxProps,
  },
  SharedWithIconProps: {
    sx: { width: `${iconSize}px`, height: `${iconSize}px` } as SxProps,
  },
  ...
  OpenConfigIconContainerProps: {
    sx: { position: "absolute", right: 40, top: 0, opacity: 0.8 } as SxProps,
  },
  OpenConfigIconProps: {
    sx: { width: `${iconSize}px`, height: `${iconSize}px` } as SxProps,
  },
  ...
  LineItem: {
    ContainerProps: {
      sx: { display: "flex", flexDirection: "row", width: "100%" } as SxProps,
    },
    TitleSpanProps: { sx: { mr: 1 } as SxProps },
    ValueSpanProps: {
      sx: { ...textEllipsis, lineHeight: `${iconSize}px` } as SxProps,
    },
  },

  NameContainerProps: {
    sx: { ...textEllipsis, textAlign: "center", pb: 1 } as SxProps,
  },
