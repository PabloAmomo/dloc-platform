import {
  Battery0BarTwoTone,
  Battery1BarTwoTone as Battery10Bar,
  Battery2BarTwoTone as Battery20Bar,
...
const BatteryIcon = (props: BatteryIconProps) => {
  const { level, iconSize = 24, fontSize = 12, iconSet = "normal", outOffVisibility }: BatteryIconProps = props;
  const iconColor: string = outOffVisibility
    ? style.Colors.red
    : level > 50
    ? style.Colors.green
    : level > 20
