...
const jt808ProcessPacket0x0102: Jt808ProcessPacket = async ({
  ...
  const parametersPackets = ["0000F102 04 " + createHexFromNumberWithNBytes(0, 2)];
  (response.response as Buffer[]).push(jt808CreateParameterSettingPacket(terminalId, counter + 103, parametersPackets));
