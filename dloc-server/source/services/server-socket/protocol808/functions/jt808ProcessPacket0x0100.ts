...
const jt808ProcessPacket0x0100: Jt808ProcessPacket = async ({
  ...
  // TODO: [VERIFY] Configure sat constallation (GPS, Beidou, Galileo)
  const parametersPackets = [
    "00000090 01 " + createHexFromNumberWithNBytes(255, 1), // Enable GPS, Beidu, and Galileo positioning (Bit 0, 1 y Bit 3)
